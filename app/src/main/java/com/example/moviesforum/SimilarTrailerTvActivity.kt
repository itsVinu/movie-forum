...
class SimilarTrailerTvActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_similar_trailer_tv)
        ...
        GlobalScope.launch {
            ...
            if (response.isSuccessful){
                if (response.body()?.results.isNullOrEmpty()){
                    ...
                    { Toast.makeText(this@SimilarTrailerTvActivity,"Trailer not available", Toast.LENGTH_LONG).show() }
                }else{
        ...
        similarRv.apply {
            layoutManager = LinearLayoutManager(this@SimilarTrailerTvActivity, RecyclerView.VERTICAL,false)
            adapter = similartvadapter
        }

        similartvadapter.onItemClick = {
            Toast.makeText(this@SimilarTrailerTvActivity,"similar tv", Toast.LENGTH_LONG).show()
