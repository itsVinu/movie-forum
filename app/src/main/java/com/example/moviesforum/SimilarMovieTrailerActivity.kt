...
class SimilarMovieTrailerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_similar_movie_trailer)
        ...
        GlobalScope.launch {
            ...
            if (response.isSuccessful){
                if (response.body()?.results.isNullOrEmpty()){
                    ...
                    { Toast.makeText(this@SimilarMovieTrailerActivity,"Trailer not available", Toast.LENGTH_LONG).show() }
                }else{
        ...
        similarRv.apply {
            layoutManager = LinearLayoutManager(this@SimilarMovieTrailerActivity,
                RecyclerView.VERTICAL,false)
            adapter = similaradapter
        }

        similaradapter.onItemClick = {
            Toast.makeText(this@SimilarMovieTrailerActivity,"similar", Toast.LENGTH_LONG).show()
